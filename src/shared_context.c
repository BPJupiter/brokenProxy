...
{
    gContext.lock_rtt = europa_mutex_create();
    gContext.lock_resolve = europa_mutex_create();
    gContext.lock_tracert = europa_mutex_create();
    gContext.lock_ping = europa_mutex_create();
...
{
    europa_mutex_destroy(gContext.lock_rtt);
    europa_mutex_destroy(gContext.lock_resolve);
    europa_mutex_destroy(gContext.lock_tracert);
    europa_mutex_destroy(gContext.lock_ping);
}
...
int sharedContext_setVariable(SCVariable var, const void *value)
{
    ...
    {
        case SCV_MAX_RTT:
            tContext.rtt_cutoff = *(double *) value;
            lock(gContext.lock_rtt);
