...
internal String8_List wm_string_list_from_modifiers(Arena *arena, WM_Modifiers modifiers)
{
...
internal String8 wm_string_from_modifiers_key(Arena *arena, WM_Modifiers modifiers, WM_Key key)
{
    ...
    if(key != WM_Key_Null)
    {
        ...
        String8_List mods = wm_string_list_from_modifiers(scratch.arena, modifiers);
...
internal u32 wm_codepoint_from_modifiers_and_key(WM_Modifiers modifiers, WM_Key key)
{
    u32 result = 0;
