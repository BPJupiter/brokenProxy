Test(str8_list_substr)
{
    ...
    
    {
        ...
        String8_List sub = str8_list_substr(arena, list, r1u64(0, 3));
    ...
    
    {
        ...
        str8_list_pushf(arena, &list, "b");
        str8_list_pushf(arena, &list, "c");
        String8_List sub = str8_list_substr(arena, list, r1u64(0, max_u64));
        String8 result = str8_list_join(arena, &list, 0);
        T_Ok(str8_match(result, str8_lit("abc"), 0));
    }
    
    {
        ...
        String8_List sub = str8_list_substr(arena, list, r1u64(2, 3));
    ...
    
    {
        ...
        str8_list_pushf(arena, &list, "a");
        str8_list_pushf(arena, &list, "bcd");
        String8_List sub = str8_list_substr(arena, list, r1u64(1, 2));
        String8 result = str8_list_join(arena, &sub, 0);
    ...
    
    {
        ...
        String8_List sub = str8_list_substr(arena, list, r1u64(1, 5));
        String8 result = str8_list_join(arena, &sub, 0);
    ...
    
    {
        ...
        String8_List zero = str8_list_substr(arena, list, r1u64(0, 0));
        T_Ok(MemoryMatchStruct(&zero, &zero_list));
        
        String8_List out_of_bounds_range = str8_list_substr(arena, list, r1u64(max_u64/2, max_u64));
...
{
    {
        ...
        for (u64 i = 10; i < test_count; ++i) {
            Hash_Map_Node *test_node = hash_map_search(&hm, hash_map_hasher(str8_struct(&i)), (Hash_Map_Key){ .key_u64 = i }, hash_map_match_u64);
        ...
        Hash_Map_Key_Value *pairs = key_value_from_hash_map(arena, &hm);
        ...
        for (Hash_Map_Node *n = hm.free_list; n != 0; n = n->next) { free_list_count += 1; }
    ...
    // test search through tombstones
    {
        ...
        hash_map_push(arena, &hm, hash, (Hash_Map_Key_Value){ .key = { .key_u64 = 1 }, .value = { .value_u64 = 10 } }, hash_map_match_u64);
        hash_map_push(arena, &hm, hash, (Hash_Map_Key_Value){ .key = { .key_u64 = 2 }, .value = { .value_u64 = 20 } }, hash_map_match_u64);
        hash_map_push(arena, &hm, hash, (Hash_Map_Key_Value){ .key = { .key_u64 = 3 }, .value = { .value_u64 = 30 } }, hash_map_match_u64);
        
        T_Ok(hash_map_purge_u64(&hm, 1));
        
        T_Ok(hash_map_search(&hm, hash, (Hash_Map_Key){ .key_u64 = 2 }, hash_map_match_u64)->v.value.value_u64 == 20);
        T_Ok(hash_map_search(&hm, hash, (Hash_Map_Key){ .key_u64 = 3 }, hash_map_match_u64)->v.value.value_u64 == 30);
    }
    ...
    // heavy collision
    {
        ...
        for EachIndex(i, count) {
                hash_map_push(arena, &hm, hash, (Hash_Map_Key_Value){ .key = { .key_u64 = i }, .value = { .value_u64 = i*3 } }, hash_map_match_u64);
            }
        
        for EachIndex(i, count) {
                T_Ok(hash_map_search(&hm, hash, (Hash_Map_Key){ .key_u64 = i }, hash_map_match_u64)->v.value.value_u64 == i*3);
            }
    }
    ...
    // duplicate key test
    {
        ...
        Hash_Map_Node *n0 = hash_map_push_u64_u64(arena, &hm, 1, a);
        Hash_Map_Node *n1 = hash_map_push_u64_u64(arena, &hm, 1, b);
