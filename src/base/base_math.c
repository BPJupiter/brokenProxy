...
internal bool32 contains_1u8(Rng1u8 r, u8 x)                       {bool32 c = (r.min <= x && x < r.max); return c;}
...
internal bool32 contains_1u16(Rng1u16 r, u16 x)                    {bool32 c = (r.min <= x && x < r.max); return c;}
...
internal bool32 contains_1u32(Rng1u32 r, u32 x)                    {bool32 c = (r.min <= x && x < r.max); return c;}
...
internal bool32 contains_1s32(Rng1s32 r, s32 x)                    {bool32 c = (r.min <= x && x < r.max); return c;}
...
internal bool32 contains_1u64(Rng1u64 r, u64 x)                    {bool32 c = (r.min <= x && x < r.max); return c;}
...
internal bool32 contains_1s64(Rng1s64 r, s64 x)                    {bool32 c = (r.min <= x && x < r.max); return c;}
...
internal bool32 contains_1f32(Rng1f32 r, f32 x)                    {bool32 c = (r.min <= x && x < r.max); return c;}
...
internal bool32 contains_2s16(Rng2s16 r, Vec2s16 x)                {bool32 c = (r.min.x <= x.x && x.x < r.max.x && r.min.y <= x.y && x.y < r.max.y); return c;}
...
internal bool32 contains_2s32(Rng2s32 r, Vec2s32 x)                {bool32 c = (r.min.x <= x.x && x.x < r.max.x && r.min.y <= x.y && x.y < r.max.y); return c;}
...
internal bool32 contains_2s64(Rng2s64 r, Vec2s64 x)                {bool32 c = (r.min.x <= x.x && x.x < r.max.x && r.min.y <= x.y && x.y < r.max.y); return c;}
...
internal bool32 contains_2f32(Rng2f32 r, Vec2f32 x)                {bool32 c = (r.min.x <= x.x && x.x < r.max.x && r.min.y <= x.y && x.y < r.max.y); return c;}
