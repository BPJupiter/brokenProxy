...
internal void base_register_test(char *func_name_cstr, Test_Function_Type *fn, char *file_path_cstr, int line, int skip)
{
    ...
    Test_Info *t = &test_infos[test_infos_count++];
