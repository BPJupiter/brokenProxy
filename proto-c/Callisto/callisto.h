...
extern void defer(void (*func)(void*), void* arg);
extern void run_deferred();
...
extern void c_debug_mem_check_defer(void (*func)(void*), void* arg);
...
#define defer(f, n) c_debug_mem_check_defer(f, n)
